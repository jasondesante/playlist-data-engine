...
Specs have been consolidated to 2 files (206 lines). See `src/core/types/` for complete TypeScript type definitions.

---

## Future Specs

Additional specifications will be added here as the project grows.
