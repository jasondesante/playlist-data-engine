...
- [x] **Task 1.2: Add image fields to CustomSkill interface**
  - [x] Edit `src/core/skills/SkillTypes.ts`
  - [x] Add `icon?: string` and `image?: string` after `lore` field (~L116)

- [x] **Task 1.3: Add image fields to ClassFeature interface**
...
- [x] **Task 1.5: Add image fields to Equipment interface**
  - [x] Edit `src/utils/constants.ts`
  - [x] Add `icon?: string` and `image?: string` after `description` field (~L626)

- [x] **Task 1.6: Add image fields to ClassDataEntry interface**
  - [x] Edit `src/utils/constants.ts`
  - [x] Add `icon?: string` and `image?: string` after `description` field (~L176)

- [x] **Task 1.7: Add image fields to EnemyTemplate interface**
  - [x] Edit `src/core/types/Enemy.ts`
  - [x] Add `icon?: string` and `image?: string` after `resistances` field (~L143)

- [x] **Task 1.8: Add image fields to StatusEffect interface**
