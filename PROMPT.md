...
study docs/plans/required-keys-implementation-plan.md and pick the most important thing to do. 
...
- update the docs/plans/required-keys-implementation-plan.md when the task is completed
