...
study docs/plans/OSE_PARAMETER_MODES_PLAN.md and pick the most important thing to do. 
...
- update the docs/plans/OSE_PARAMETER_MODES_PLAN.md when the task is completed
