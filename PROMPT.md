...
study docs/plans/two-step-model-architecture.md and pick the most important thing to do. 
...
- update the docs/plans/two-step-model-architecture.md when the task is completed
