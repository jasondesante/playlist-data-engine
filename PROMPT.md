...
study docs/plans/RESOLVEURL_CLEANUP_PLAN.md and pick the most important thing to do. 
...
I might add new stuff to the docs/plans/RESOLVEURL_CLEANUP_PLAN.md file based on me monitoring your progress. If you see that, add/edit tasks based on those requests, add new tasks to the list, uncheck tasks that I state need to be done again, and cross out what I wrote to signify you acknowledged my notes.
...
- update the docs/plans/RESOLVEURL_CLEANUP_PLAN.md when the task is completed
