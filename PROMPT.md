...
study BOX_ITEM_TYPE_IMPLEMENTATION_PLAN.md and pick the most important thing to do. 
...
- update the BOX_ITEM_TYPE_IMPLEMENTATION_PLAN.md when the task is completed
