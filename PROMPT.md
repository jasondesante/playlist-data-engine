...
study PLAN_REMOVE_REDUNDANT_REGISTRY_METHODS.md and pick the most important thing to do. 
...
- update the PLAN_REMOVE_REDUNDANT_REGISTRY_METHODS.md when the task is completed
