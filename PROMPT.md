...
study docs/plans/beat-subdivision-implementation-plan.md and pick the most important thing to do. 
...
- update the docs/plans/beat-subdivision-implementation-plan.md when the task is completed
