...
// Default: Non-deterministic (slightly different each time)
const name1 = namingEngine.generateName(track, audioProfile);
const name2 = namingEngine.generateName(track, audioProfile);
console.log(`Name variation 1: "${name1}"`);
console.log(`Name variation 2: "${name2}"`);
// Examples: "Sonic Midnight City the Bard", "Electric Dreams the Wizard", "Thumping Nexus of Daft Punk"

// Optional: Deterministic mode (same track always produces same name)
const deterministicName = namingEngine.generateName(track, audioProfile, true);
console.log(`Deterministic name: "${deterministicName}"`);
// Always the same for this track
```
