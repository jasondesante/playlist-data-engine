/**
 * Integration tests for Custom Classes
 *
 * Tests the template-based custom class system including:
 * - Character generation with custom classes
 * - Custom class data with baseClass inheritance
 * - Helper functions integration (getClassData, getClassSpellList, etc.)
 * - Template class pattern examples (Necromancer, BattleMage, etc.)
 *
 * Part of Phase 7.2: Write integration tests for custom classes.
 */
...
import { getClassData, getClassSpellList, getSpellSlotsForClass } from '../../src/utils/constants';
import { getClassStartingEquipment } from '../../src/utils/equipmentConstants';
