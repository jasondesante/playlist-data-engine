/**
 * Example Magic Items for Playlist Data Engine
 *
 * This file demonstrates all capabilities of the Advanced Equipment System:
...
import type { EnhancedEquipment, EquipmentMiniFeature } from '../core/types/Equipment.js';

/**
 * Example Magic Items demonstrating all equipment system capabilities
 */
export const MAGIC_ITEM_EXAMPLES: EnhancedEquipment[] = [
    // ========================================================================
    // WEAPONS
    // ========================================================================
...
/**
 * Magic Equipment Templates for enchantment
 * These can be applied to base weapons to create magic variants
 */
export const MAGIC_EQUIPMENT_TEMPLATES: Record<string, Partial<EnhancedEquipment>> = {
    /**
...
export function getMagicItem(name: string): EnhancedEquipment | undefined {
    return MAGIC_ITEM_EXAMPLES.find(item => item.name === name);
}
...
export function getMagicItemsByType(type: 'weapon' | 'armor' | 'item'): EnhancedEquipment[] {
    return MAGIC_ITEM_EXAMPLES.filter(item => item.type === type);
}
...
export function getMagicItemsByRarity(rarity: 'common' | 'uncommon' | 'rare' | 'very_rare' | 'legendary'): EnhancedEquipment[] {
    return MAGIC_ITEM_EXAMPLES.filter(item => item.rarity === rarity);
}
...
export function getCursedItems(): EnhancedEquipment[] {
    return MAGIC_ITEM_EXAMPLES.filter(item => item.tags?.includes('cursed'));
}
...
export function getItemsWithProperty(propertyType: string): EnhancedEquipment[] {
    return MAGIC_ITEM_EXAMPLES.filter(item =>
...
export function applyTemplate(baseEquipment: EnhancedEquipment, templateId: string): EnhancedEquipment | null {
    const template = MAGIC_EQUIPMENT_TEMPLATES[templateId];
    if (!template) {
        return null;
    }
...
export default MAGIC_ITEM_EXAMPLES;
